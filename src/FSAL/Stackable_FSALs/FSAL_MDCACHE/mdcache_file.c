 ...
 */
fsal_status_t mdcache_copy(struct fsal_obj_handle *src_hdl,
                                      uint64_t src_offset,
                                      ...
                                      uint64_t *copied)
{
	...
	LogDebug(COMPONENT_FSAL, "In mdcache_copy");
	...
	/**
        ...
        subcall(
                fsal_status = src_entry->sub_handle->obj_ops.copy(
                                src_entry->sub_handle, src_offset,
				dst_entry->sub_handle, dst_offset,
				count, copied)
               );
	...
	LogDebug(COMPONENT_FSAL, "Exited mdcache_copy");	
	return fsal_status;
}
